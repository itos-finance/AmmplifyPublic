...
//     //         tokens.push(address(new MockERC20(string.concat("Test Token ", idx), string.concat("TEST", idx), 18)));
//     //     }
...
//     //         vaults.push(
//     //             IERC4626(
//     //                 address(new MockERC4626(ERC20(tokens[i]), string.concat("Vault ", idx), string.concat("V", idx)))
//     //             )
//     //         );
