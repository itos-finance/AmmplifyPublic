...
import { VaultType, VaultProxyImpl } from "../../src/vaults/VaultProxy.sol";
...
contract VaultMultiTest is MultiSetupTest {
    ...
    //     MockERC4626WithdrawlLimited vault = new MockERC4626WithdrawlLimited(token0, "Test Vault", "TVLT", 1e18);
    ...
    //     vm.expectRevert(
    //         abi.encodeWithSelector(VaultProxyImpl.WithdrawLimited.selector, 0x3, 10246160703694265782, 1e18 + 3)
    //     );
    ...
    //     vm.expectRevert(
    //         abi.encodeWithSelector(VaultProxyImpl.WithdrawLimited.selector, 0x3, 2033158300660175021, 1e18)
    //     );
    //     valueFacet.removeValueSingle(owner, 0x3, 2e18, 0, tokens[0], 0);
    //     vm.stopPrank();
