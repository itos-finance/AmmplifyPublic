...
contract CapricornFork is AmmplifyForkBase {
    ...
    // TODO: V4 migration - Opener tests require V4 PoolManager fork infrastructure.
    // The Opener now uses V4's unlock/swap pattern instead of V3 pool.swap().
    // These tests need a V4ForkBase that deploys/forks a V4 PoolManager.
}
