 ...
 *
 * This script reads token addresses from addresses JSON and mints
...
contract MintTokens is Script {
    ...
    function run() external {
        ...
        // Load token addresses from addresses JSON
        _loadTokenAddresses();
    ...
    /**
     * @notice Load token addresses from environment variables or addresses JSON
     */
    function _loadTokenAddresses() internal {
        ...
        try vm.envAddress("USDC_TOKEN") returns (address usdcAddr) {
            ...
            console.log("Using USDC token from addresses JSON:", address(usdcToken));
        }
        ...
        try vm.envAddress("WETH_TOKEN") returns (address wethAddr) {
            ...
            console.log("Using WETH token from addresses JSON:", address(wethToken));
        }
