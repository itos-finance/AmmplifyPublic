...
/**
 * @title GetPoolTokens
 * @dev Script to read pool address from addresses JSON and get token0/token1
 *
 * This script:
 * - Reads the WETH_USDC_3000 pool address from addresses JSON
...
contract GetPoolTokens is Script {
    // Pool address from addresses JSON
