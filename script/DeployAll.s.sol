...
contract DeployAll is Script {
    ...
    function _deploySwapRouter() internal {
        // Write necessary addresses to deployed-addresses.json for DeploySimpleSwapRouter
        _updateDeployedAddressesJson();
    ...
    /**
     * @notice Update deployed-addresses.json with current deployment addresses
     */
    function _updateDeployedAddressesJson() internal {
        // Get the deployer's address from environment
        address deployer = vm.envAddress("DEPLOYER_PUBLIC_KEY");

        // Create JSON content with current deployment addresses
        ...
        console.log(unicode"📝 Updated deployed-addresses.json with current deployment addresses");
    }
